...
public abstract class JoystickHandler : MonoBehaviour, IDragHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    [SerializeField] private Color _enabledJoystickColor;
    [SerializeField] private Color _disabledJoystickColor;
    ...
    private void ClickEffect()
    {
        ...
        {
            _joystick.color = _enabledJoystickColor;
            _joystickIsActive = true;
        }
        else
        {
            _joystick.color = _disabledJoystickColor;
